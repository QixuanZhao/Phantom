...
ListView {
    ...
    delegate: RowLayout {
        ...
        RoundButton {
            flat: true
            enabled: false
            icon.source: "qrc:/static/res/icons/lightbulb_FILL0_wght400_GRAD0_opsz48.svg"
        ...
        RoundButton {
            ...
            checkable: true
            checked: index === controller.lighting.pickedPointLightIndex
            highlighted: checked
            onClicked: {
                if (controller.lighting.pickedPointLightIndex === index) controller.lighting.pickedPointLightIndex = -1
                else {
                    controller.lighting.pickedSpotlightIndex = -1
                    controller.lighting.pickedPointLightIndex = index
                }
            }
        }
        RoundButton {
        ...
        RoundButton {
            ...
            onClicked: {
                if (pickedButton.checked) controller.lighting.pickedPointLightIndex = -1
